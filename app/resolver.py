...
def resolve_query(query, authoritative_cache, resolver_cache, root_server: RootServer, tld_server: TLDServer, authoritative_server: AuthoritativeServer, recursive, is_tcp=False):
    """
